...
|--------------------------------------------------------------------------
|
| The database remains the ONLY source of:
| - category ID
| - category name
| - category slug
| - active state
| - product count
|
| Images/colors/icons are presentation only.
|--------------------------------------------------------------------------
*/
...
|
| IMPORTANT:
| No hard-coded category list is used here.
|
| Guest Home receives categories from the same database
| used by Seller and Buyer.
|--------------------------------------------------------------------------
*/
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <Link
                        :href="safeRoute('guest.product', '#', featuredProduct.id)"
                ...
                >
                    ...
                    >
                        ...
                        <Link
                            ...
                            :href="safeRoute('guest.product', '#', product.id)"
