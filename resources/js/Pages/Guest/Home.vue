...
const categories = computed(() =>
    props.categories.map(category => ({
        ...category,
        ...getStyle(category.slug),
        items: category.products_count ?? 0,
    }))
)
...
| Top Selling Product
|--------------------------------------------------------------------------
| Uses the highest available sold count.
| For exact sales data, the Laravel controller must provide sold_count.
|--------------------------------------------------------------------------
*/
    ...
    <GuestLayout>
        ...
        <div class="min-h-screen overflow-hidden bg-[#F8FAF9] text-[#1F2937]">
            ...
            <section class="relative">
                ...
                <div
                    class="mx-auto max-w-[1440px] px-4 pb-8 pt-5 sm:px-6 lg:px-8 xl:pb-12"
                >

                    <div
                        class="relative overflow-hidden rounded-[32px] bg-[#087F8C]"
                    >
                        ...
                        <div
                            class="absolute right-[32%] top-16 h-24 w-24 rounded-full bg-white/[0.04]"
                        ></div>

                        <div
                            class="relative grid min-h-[490px] grid-cols-1 lg:grid-cols-[1.05fr_.95fr]"
                        >
                            ...
                            >
                                ...
                                <h1
                                    class="max-w-2xl text-4xl font-black leading-[0.98] tracking-[-0.04em] text-white sm:text-5xl lg:text-6xl xl:text-[68px]"
                                >
                                    Find your next
                                ...
                                <p
                                    class="mt-6 max-w-xl text-sm leading-6 text-teal-50 sm:text-base sm:leading-7"
                                >
                                    A fresh marketplace for everyday finds,
                                    useful essentials, exciting deals, and
                                    products from sellers worth discovering.
                                </p>
                            ...
                            <div
                                class="relative flex min-h-[330px] items-center justify-center lg:min-h-0"
                            >

                                <!-- Large Circle -->

                                <div
                                    class="absolute h-[280px] w-[280px] rounded-full bg-white/[0.08] sm:h-[360px] sm:w-[360px] lg:h-[420px] lg:w-[420px]"
                                ></div>

                                <div
                                    class="absolute h-[220px] w-[220px] rounded-full border border-white/10 sm:h-[300px] sm:w-[300px]"
                                ></div>
            ...
            <section
                ...
                class="mx-auto max-w-[1440px] px-4 py-7 sm:px-6 lg:px-8 lg:py-9"
            >
                ...
                >
                    ...
                    <Link
                        :href="route('guest.product', featuredProduct.id)"
                    ...
                    >
                        ...
                        >
                            Discover this popular product from one of our
                            Alona sellers.
                        </p>
                        ...
                        >
                            ...
                            <span>
                                {{ featuredProduct.soldCount }} sold
                            </span>
            ...
            <section class="border-y border-gray-100 bg-white">
                ...
                <div
                    class="mx-auto max-w-[1440px] px-4 py-12 sm:px-6 lg:px-8"
                >
                    ...
                    <div
                        ...
                        class="mt-7 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4"
                    >
                        ...
                        >
                            ...
                            <div
                                class="relative aspect-[.92] overflow-hidden rounded-[24px] bg-[#F4F7F6]"
                            >
                    ...
                    >
                        ...
                        >
                            Check back soon for new products from Alona
                            sellers.
                        </p>
                ...
                >
                    ...
                    >
                        ...
                        <div>
                            ...
                            >
                                Good finds don't have to be complicated.
                            </h2>

                            <p
                                class="mt-3 max-w-xl text-sm leading-6 text-[#087F8C]/75"
                            >
                                Browse products, discover new sellers, and
                                find something that fits your everyday life.
                            </p>

                        </div>

                        <Link
                            :href="safeRoute('guest.deals', route('guest.products'))"
            ...
            <section class="bg-[#087F8C]">
                ...
                <div
                    class="mx-auto max-w-[1440px] px-4 py-14 sm:px-6 lg:px-8 lg:py-16"
                >
                    ...
                    >
                        ...
                        <div>
                            ...
                            >
                                Alona brings products and sellers together
                                through a marketplace designed to keep
                                discovering simple.
                            </p>
                        ...
                        <div class="grid gap-4 sm:grid-cols-3">
                            ...
                            <div
                                ...
                                :key="benefit.number"
                                class="rounded-[24px] border border-white/10 bg-white/[0.07] p-5 transition hover:-translate-y-1 hover:bg-white/10"
                            >
            ...
            >
                ...
                >
                    ...
                    <div
                        class="absolute -bottom-16 right-24 h-32 w-32 rounded-full bg-[#F4B942]/20"
                    ></div>
                    ...
                    >
                        ...
                        <div>
                            ...
                            >
                                ...
                                and grow your business with Alona.
                            </p>
            ...
            <section class="border-t border-gray-100 bg-white">
                ...
                >
                    ...
                    >
                        Explore the Alona marketplace and find products from
                        different categories in one place.
                    </p>
