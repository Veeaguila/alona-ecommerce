...
| Profile photo
|--------------------------------------------------------------------------
| The selected image is previewed immediately. The file is submitted through
| the existing buyer.account.update endpoint as `profile_photo`.
| The existing saved photo is resolved from common user fields so this works
| with either a full URL or a stored public path.
|--------------------------------------------------------------------------
*/
...
<template>
    <section class="min-w-0">
        <!-- PROFILE HEADER -->
        <div class="rounded-2xl border border-[#DDE8E8] bg-white p-4 shadow-[0_8px_30px_rgba(15,23,42,0.05)] sm:p-5">
            <div class="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                <div class="flex min-w-0 items-center gap-4">
                    <!-- PROFILE PHOTO -->
                    <label class="group relative block h-20 w-20 shrink-0 cursor-pointer sm:h-24 sm:w-24">
                        <div class="h-full w-full overflow-hidden rounded-2xl bg-[#E8F7F6] ring-4 ring-white shadow-md">
                            <img
                        ...
                        <div class="absolute inset-0 flex items-center justify-center rounded-2xl bg-black/45 opacity-0 transition group-hover:opacity-100">
                            <div class="text-center text-white">
                                ...
                                <span class="mt-1 block text-[9px] font-bold">
                                    Change photo
                                </span>
                            </div>
                        </div>
                        ...
                        <span class="absolute -bottom-1 -right-1 flex h-7 w-7 items-center justify-center rounded-full border-2 border-white bg-[#F4B942] text-[#1F2937] shadow-sm">
                            <svg
                                class="h-3.5 w-3.5"
                                viewBox="0 0 24 24"
                                fill="none"
                    ...
                    <div class="min-w-0">
                        <div class="flex items-center gap-2">
                            ...
                            <p class="text-[9px] font-extrabold uppercase tracking-[0.18em] text-[#087F8C] sm:text-[10px]">
                                Alona profile
                            </p>
                        </div>

                        <h2 class="mt-1 truncate text-lg font-extrabold text-[#1F2937] sm:text-xl">
                        ...
                        <label class="mt-2 inline-flex cursor-pointer items-center gap-1.5 text-[10px] font-bold text-[#087F8C] hover:text-[#066B76]">
                ...
                <div class="rounded-xl bg-[#F8FAF9] px-3 py-2.5 text-left sm:max-w-xs sm:text-right">
                    <p class="text-[9px] font-extrabold uppercase tracking-[0.12em] text-[#94A3B8]">
                        Profile tip
                    </p>
                    <p class="mt-1 text-[10px] leading-4 text-[#64748B]">
        ...
        <div class="mt-5">
            <div class="flex items-center gap-2">
                ...
                <p class="text-[10px] font-extrabold uppercase tracking-[0.18em] text-[#087F8C]">
                    Account details
                </p>
            </div>

            <h3 class="mt-1 text-xl font-extrabold tracking-tight text-[#1F2937] sm:text-2xl">
                Personal information
            </h3>

            <p class="mt-1 text-xs text-[#64748B] sm:text-sm">
        ...
        >
            <!-- PERSONAL INFORMATION -->
            <div class="rounded-2xl border border-[#E5E7EB] bg-white p-4 shadow-[0_5px_20px_rgba(15,23,42,0.035)] sm:p-5">
                <div class="mb-4">
                ...
                <div class="grid gap-3 sm:grid-cols-2">
                    ...
                    <!-- Age -->
                    <label>
                        <span class="label">Age (auto)</span>
                        <input
                            :value="age"
                            readonly
            ...
            <div class="rounded-2xl border border-[#E5E7EB] bg-white p-4 shadow-[0_5px_20px_rgba(15,23,42,0.035)] sm:p-5">
                ...
                <div class="grid gap-3">
                    ...
                    >
                        <p class="text-[10px] font-bold text-[#8A6200]">
            ...
            <!-- ADDRESS -->
            <div class="rounded-2xl border border-[#E5E7EB] bg-white p-4 shadow-[0_5px_20px_rgba(15,23,42,0.035)] sm:col-span-2 sm:p-5">
                <div class="mb-4 flex items-start justify-between gap-3">
                    ...
                    <span class="hidden rounded-full bg-[#E8F7F6] px-2.5 py-1 text-[9px] font-extrabold text-[#087F8C] sm:inline-flex">
                        PSGC assisted
                    </span>
                </div>
                ...
                <div class="grid gap-3 sm:grid-cols-3">
                    ...
                    <label>
                        ...
                        <select
                            ...
                            required
                            class="field"
                            :disabled="!provinceCode || loadingMunicipalities"
                        >
                            <option value="">
                    ...
                    <label class="sm:col-span-3">
                        <span class="label">Street, house number, and other details *</span>
                        <textarea
            ...
            <div class="rounded-2xl border border-[#E5E7EB] bg-white p-4 shadow-[0_5px_20px_rgba(15,23,42,0.035)] sm:p-5">
                ...
                <label>
                    <span class="label">Replace uploaded ID</span>
                    <input
                        type="file"
                        accept=".jpg,.jpeg,.png,.pdf"
                        class="field file-field"
                        @change="form.id = $event.target.files?.[0] || null"
                    />
            ...
            <!-- ACTIONS -->
            <div class="flex flex-col justify-center rounded-2xl border border-[#CDE9E4] bg-[#E8F7F6] p-4 sm:p-5">
                <p class="text-[10px] font-extrabold uppercase tracking-[0.12em] text-[#087F8C]">
                    Ready to save?
                </p>
                ...
                <div class="mt-4 flex flex-wrap items-center gap-3">
                    ...
                    >
                        <span class="flex h-4 w-4 items-center justify-center rounded-full bg-[#22A06B] text-white">
                            ✓
                        </span>
